    ...
    <KeyboardAvoidingView style={styles.container} behavior={keyboardAvoidingBehavior}>
      ...
      >
        <View style={styles.hero}>
          <Text style={styles.heroTitle}>{AppStrings.register.title}</Text>
          <Text style={styles.heroSubtitle}>{AppStrings.register.subtitle}</Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.label}>{AppStrings.register.emailLabel}</Text>
          <TextInput
          ...
          <Text style={[styles.label, styles.labelSpacing]}>
            {AppStrings.register.passwordLabel}
          </Text>
          ...
          <TouchableOpacity style={styles.linkButton} onPress={() => navigate(RouteEnum.LOGIN)}>
